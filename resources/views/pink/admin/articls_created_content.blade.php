<div id="content-page" class="content group">
    <div class="hentry group">
        ...
        {!! Form::open(['url' => (isset($article->id)) ? route('articls.update',['articles'=>$article->alias]) : route('articls.store'),'class'=>'contact-form','method'=>'POST','enctype'=>'multipart/form-data']) !!}
