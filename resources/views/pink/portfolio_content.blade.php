            ...
            <div id="portfolio" class="portfolio-full-description">
                ...
                <div class="portfolio-full-description-related-projects">
                    ...
                    <div class="related_project">
                        <a class="related_proj related_img" href="{{ route('portfolios.show', ['alias'=>$portfolio->alias]) }}" title="{{ $portfolio->title }}"><img src="{{ asset('pink/images/projects/'.$portfolio->img->mini) }}" alt="0061" title="0061" /></a>
